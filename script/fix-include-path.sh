        ...
        for line in $lines ; do
            ...
            if [[ $hdr_path != "" ]] ; then
                ...
                if [[ "$hdr" != "$new_hdr" ]] ; then
                    ...
                    sed_cmd=${sed_cmd}"$lineno {s|$(escape_slash $hdr_org)|$(escape_slash $new_hdr)|g}"$'\n'
                fi
            fi
        done
